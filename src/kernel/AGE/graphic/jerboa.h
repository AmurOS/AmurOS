...
// Тушканчик
//
// Тушканчиковые Семейство млекопитающих, объединяющее группу грызунов, населяющих степи, полупустыни и пустыни
// Палеарктики и приспособленных к специфическим условиям обитания в этих ландшафтах.
//
// graphics
