...
void *__std__malloc_ptr;
void *__std__malloc(unsigned int sz)
{
  void *ret;
  ret = (void*)__std__malloc_ptr;
  __std__malloc_ptr += sz;
  return ret;
}
...
bool __std__strcmp(char *input, char *check)
{
	...
	const unsigned char *p1 = ( const unsigned char * )input;
    const unsigned char *p2 = ( const unsigned char * )check;

    while ( *p1 && *p1 == *p2 ) ++p1, ++p2;

    return (bool)(( *p1 > *p2 ) - ( *p2  > *p1 ));
}
